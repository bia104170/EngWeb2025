exports.genMainPage = function(d) {
    var pagHTML = `
    <!DOCTYPE html>
    <html>
        <head>
    ...
    for(let i=0; i < slist.length ; i++){
        pagHTML += `
                <tr>
                    ...
                    <td>
                        <a href="/alunos/edit/${slist[i].id}" class="w3-button w3-green w3-round" style="width:100px;">Edit</a>
                        <a href="/alunos/delete/${slist[i].id}" class="w3-button w3-red w3-round" style="width:100px;">Delete</a>
                    </td>
